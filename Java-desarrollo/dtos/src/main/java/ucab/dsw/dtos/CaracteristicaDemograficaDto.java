...
public class CaracteristicaDemograficaDto extends BaseDto {


    public CaracteristicaDemograficaDto()
    {
    }

    public CaracteristicaDemograficaDto(long id ) throws Exception
    {
        super( id );
    }
