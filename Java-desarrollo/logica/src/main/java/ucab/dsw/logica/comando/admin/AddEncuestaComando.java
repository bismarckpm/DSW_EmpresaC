...
public class AddEncuestaComando extends BaseComando {
    ...
    public void execute() throws EmpresaException{
        try {
            ...
            ex.printStackTrace();
            throw new EmpresaException("C-ADM04-DUP",ex.getMessage(), "La Pregunta ya se encuestra registrada en la encuesta");
        }
    }
    ...
    public JsonObject getResult() throws EmpresaException{
        try{
            ...
            ex.printStackTrace();
            throw new EmpresaException("C-ADM04-G-NULL","Ha ocurrido un error en los JsonObject - Cause: Null key/pair","Error. Intente mas tarde.");
        }
    }
}
