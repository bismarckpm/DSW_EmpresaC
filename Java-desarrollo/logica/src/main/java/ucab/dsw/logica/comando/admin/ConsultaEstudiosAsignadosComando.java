...
public class ConsultaEstudiosAsignadosComando extends BaseComando{
    ...
    public void execute() throws EmpresaException{
        try {
            ...
            throw new EmpresaException("C-ADM01-E-NULL","Ha ocurrido un error en los JsonObject - Cause: Null key/pair","Error. Intente mas tarde.");
        }
    }
    ...
    public JsonObject getResult() throws EmpresaException{
        try{
            JsonObject data= Json.createObjectBuilder().add("mensaje","Estudios asignados")
                    .add("estado","success")
            ...
            throw new EmpresaException("C-ADM01-G-NULL","Ha ocurrido un error en los JsonObject - Cause: Null key/pair","Error. Intente mas tarde.");
        }
    }
