...
public class PreguntaEstudioComando extends BaseComando {
    ...
    public void execute() throws EmpresaException{
        try{
            ...
            throw new EmpresaException("C-ENC04-E-NULL","Ha ocurrido un error en los JsonObject - Cause: Null key/pair","Error. Intente mas tarde.");
        }
    ...
    public JsonObject getResult() throws EmpresaException{
        try{
            ...
            ex.printStackTrace();
            throw new EmpresaException("C-ENC04-G-NULL", "Ha ocurrido un error en los JsonObject - Cause: Null key/pair", "Error. Intente mas tarde.");
        }
    }
}
