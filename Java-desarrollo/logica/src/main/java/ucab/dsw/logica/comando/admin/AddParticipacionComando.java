...
public class AddParticipacionComando extends BaseComando {
    ...
    public void execute() throws EmpresaException{
        ...
        throw new EmpresaException("C-ADM9-E-NULL","Ha ocurrido un error en los JsonObject - Cause: Null key/pair","Error. Intente mas tarde.");
    }
    }
    ...
    public JsonObject getResult() throws EmpresaException{
        try{
            ...
            throw new EmpresaException("C-ADM9-G-NULL","Ha ocurrido un error en los JsonObject - Cause: Null key/pair","Error. Intente mas tarde.");
        }
    }
}
